...
var responseTimeChart = new LocustLineChart($(".charts-container"), "Response Times (ms)", ["99% Response Time", "95% percentile"], "ms");
...
function updateStats() {
    $.get('./stats/requests', function (report) {
        ...
        if (report.state !== "stopped"){
            ...
            responseTimeChart.addValue([report.current_response_time_percentile_99, report.current_response_time_percentile_95]);
